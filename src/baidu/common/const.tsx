...
export const html_check_md5 = `<p ${styleText}>测试秒传, 可防止秒传失效<a id="check_md5_btn" ${styleBtn}><span class="text" style="width: auto;">测试</span></a></p>`;
export const html_document = `<p ${styleText}>秒传无效/md5获取失败/防和谐 可参考<a ${styleBtn} href="https://shimo.im/docs/TZ1JJuEjOM0wnFDH" rel="noopener noreferrer" target="_blank"><span class="text" style="width: auto;">分享教程</span></a></p>`;
