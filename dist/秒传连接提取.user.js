    ...
    (() => {
        ...
        var Swalbase = function() {
            ...
            Swalbase.prototype.mergeArg = function() {
                ...
                var output = {};
                $.extend.apply($, __spreadArray([ output, this.swalArgs ], inputArgs, false));
                return output;
            };
        ...
        var htmlBtnRapidNew = '<button id="bdlink_btn" style="margin-left: 8px;" class="u-btn nd-file-list-toolbar-action-item u-btn--primary u-btn--default u-btn--small is-round is-has-icon"><i class="iconfont icon-copy"></i><span>秒传</span></button>';
        ...
        var checkBox = __webpack_require__(722);
        var checkBox_default = __webpack_require__.n(checkBox);
        var app = __webpack_require__(419);
