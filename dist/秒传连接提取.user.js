...
var updateInfoVer = "2.2.5"; // 更新弹窗的版本, 有些没必要提示的小更新就不弹窗了
...
var Swalbase = /** @class */ (function () {
    ...
    Swalbase.prototype.finishView = function (isGen) {
        ...
        var swalArg = __assign(__assign({ title: action + "\u5B8C\u6BD5 \u5171" + fileInfoList.length + "\u4E2A, \u5931\u8D25" + parseResult.failedCount + "\u4E2A!", confirmButtonText: isGen || this.rapiduploadTask.checkMode ? "复制秒传代码" : "确认", html: html + htmlFooter }, ((isGen || this.rapiduploadTask.checkMode) && checkboxArg)), { willOpen: function () {
    ...
    Swalbase.prototype.genUnfinish = function (onConfirm, onCancel) {
        Swal.fire(this.mergeArg(GM_getValue("unClose")
