...
(() => {
    ...
    (() => {
        ...
        var doc = {
            shareDoc: "https://shimowendang.com/docs/TZ1JJuEjOM0wnFDH",
            linkTypeDoc: "https://shimowendang.com/docs/hTCKJHPJRkp8PDR8"
        };
            ...
            Swalbase.prototype.addOpenDirBtn = function() {
                if (!this.rapiduploadTask.isDefaultPath) {
                    ...
                    btn.onclick = function() {
                        ...
                        if (path) location.href = location.href.replace(path[1], "path=" + encodeURIComponent(_dir_1));
                        Swal.close();
                    };
                    cBtn.before(btn);
                }
